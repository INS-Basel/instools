...
#' @rdname scale_custom
#' @export
scale_color_discrete_unibas <- function(palette = "unibas_palette", extend = FALSE, ...){
...
#' @rdname scale_custom
#' @export
scale_colour_discrete_unibas <- scale_color_discrete_unibas

#' @rdname scale_custom
#' @export
scale_fill_discrete_unibas <- function(palette = "unibas_palette", extend = FALSE, ...){
...
#' @rdname scale_custom
#' @export
scale_color_opinionated_unibas <- function(palette = "unibas_palette", ...){
...
#' @rdname scale_custom
#' @export
scale_colour_opinionated_unibas <- scale_color_discrete_unibas

#' @rdname scale_custom
#' @export
scale_fill_opinionated_unibas <- function(palette = "unibas_palette", ...){
...
#' @rdname scale_custom
#' @export
scale_color_diverging_unibas <- function(palette = "unibas_palette", ...) {
...
#' @rdname scale_custom
#' @export
scale_colour_diverging_unibas <- scale_color_diverging_unibas

#' @rdname scale_custom
#' @export
scale_fill_diverging_unibas <- function(palette = "unibas_palette", ...) {
...
#' @rdname scale_custom
#' @export
scale_color_continuous_unibas <- function(palette = "unibas_palette", ...) {
...
#' @rdname scale_custom
#' @export
scale_colour_continuous_unibas <- scale_color_continuous_unibas

#' @rdname scale_custom
#' @export
scale_fill_continuous_unibas <- function(palette = "unibas_palette", ...) {
